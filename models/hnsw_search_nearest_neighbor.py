...
class HnswSearchNearestNeighbor:
    def __init__(self, config: dict):
        ...
        self.dim = config['hnsw']['dimension']  # Dimension of the MinHash signatures
        self.max_elements = config['hnsw']['max_elements']  # Maximum number of elements in HNSW index
        self.log = Log("HnswSearchNearestNeighbor", config)
